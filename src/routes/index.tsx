...
const TITLE = "Chumtiya Detector — A 15-Question Personality Diagnosis";
const DESCRIPTION =
  "A fast, funny 15-question survey that measures exactly how convinced you are that everyone around you is a chumtiya. Not a real test.";
