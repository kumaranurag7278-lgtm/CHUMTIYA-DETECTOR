...
const TITLE = "Chumtiya Detector — A 17-Question Personality Diagnosis";
const DESCRIPTION =
  "A fast, funny 17-question survey that measures exactly how convinced you are that everyone around you is a chumtiya. Not a real test.";
