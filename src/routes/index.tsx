...
const TITLE = "Chutiya Detector — A 13-Question Personality Diagnosis";
const DESCRIPTION =
  "A fast, funny 13-question survey that measures exactly how convinced you are that everyone around you is a chutiya. Not a real test.";
